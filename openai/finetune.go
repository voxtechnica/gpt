...
// PromptSeparator is a recommended separator between the prompt and the completion.
const PromptSeparator = "\n\n###\n\n"

// CompletionStart is a recommended prefix for the completion.
const CompletionStart = " "

// CompletionStop is a recommended suffix for the completion.
const CompletionStop = "\n"

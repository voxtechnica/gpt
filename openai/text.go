...
// TextRequest represents a text completion API request.
...
// String produces a simple text display of the CompletionRequest intended for console output.
func (c *TextRequest) String() string {
	s := "--------------------\n" + c.Model
	if c.Temperature > 0 {
...
// TextResponse provides a predicted text completion in response to a provided
...
// String provides a simple text display of the Completion intended for console output.
func (c *TextResponse) String() string {
	var s string
	for _, t := range c.Choices {
		s += t.String()
	}
	var finish string
	if len(c.Choices) > 0 {
...
// String provides a simple text display of the TextChoice intended for console output.
func (t *TextChoice) String() string {
